...
function fig_2015_0105_0100_ps_arc_v01, plot_file, event_info=event_info
...
;---plot_vars options
    ...
    foreach time, times, time_id do begin
        ...
        ;the_mlt_range = 22.5-24+[-1,1]*dmlt
    ...
    var = pf_var
    options, var, 'yrange', [-200,100]
    options, var, 'ytickv', [-150,-50,50]
    options, var, 'yticks', 2
...
;---Plot.
    ...
    if count ne 0 then begin
        ...
        tx = tmp[0]+xchsz*0.5
        ty = tmp[1]+ychsz*0.3
        xyouts, tx,ty,normal=1, 'RBSP-'+strupcase(probe)+'!C+'+string(dmlat,format='(I0)')+' deg', charsize=label_size, alignment=0, color=rbsp_color
    endif
...
print, fig_2015_0105_0100_ps_arc_v01(event_info=event_info)
end