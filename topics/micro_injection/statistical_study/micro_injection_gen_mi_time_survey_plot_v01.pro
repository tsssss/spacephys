...
pro micro_injection_gen_mi_time_survey_plot_v01, mission_probe, test=test
    ...
    plot_root = join_path([plot_root,'micro_injection_'+version])
...
;---Loop through plot_trs.
    ...
    ;---Survey plot.
        base = 'micro_injection_mi_times_survey_plot_'+time_string(time_range[0],tformat='YYYY_MMDD')+'_'+mission+'_'+probe+'_v01.pdf'
...
mission_probe = ['mms','1']
test = 1
micro_injection_gen_mi_time_survey_plot_v01, mission_probe, test=test
end