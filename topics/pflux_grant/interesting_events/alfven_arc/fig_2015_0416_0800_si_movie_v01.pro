;+
; Generate the movei for supplemental information.
;
; Adopted from fig_si_movie
;-

function fig_2015_0416_0800_si_movie_v01, movie_file, event_info=event_info
...
;---asi.
    ...
    if mlt_type eq 'pre_midn' then begin
        ...
        mlt_images = mlt_images[index,npx*0.5-1:npx-1,0:npx*0.5-1]
    endif else if mlt_type eq 'night' then begin
...
print, fig_2015_0416_0800_si_movie_v01(event_info=event_info)
end
