;+
; Read solar wind V in given coord.
;-

function ml_omni_read_sw_v, input_time_range, get_name=get_name, coord=input_coord
...
;---Check input time range.
    ...
    gse_var = ml_omni_read_param_var(input_time_range, var='sw_v_gse', errmsg=errmsg)
...
var = ml_omni_read_sw_v(time_range, coord='gsm')
var = ml_omni_read_param_var(time_range, var='sw_p')
end