;+
; Plot AE, ewograms of DP, upward current.
;-

pro fig_ewogram_of_dp_and_current, time_range, probes=probes, $
    ...
    if n_elements(plot_file) eq 0 then plot_file = join_path([homedir(),'fig_ewogram_of_dp_and_current_'+strjoin(time_string(time_range,tformat='YYYY_MMDD_hh'),',')+'_v01.pdf'])
    if keyword_set(test) then plot_file = 0

;---Read theta, mlt, r_sm, j_ewo_var.
    time_step = 10.
...
fig_ewogram_of_dp_and_current, time_range, probes=probes, test=0, mlt_range=mlt_range
end
