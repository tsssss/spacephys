...
pro fig_2013_0607_05_tilt_angle, sort_by=sort_by, sort=sort
...
;---Add settings.
    ...
    df_info['g15'].time_range = time_double(['2013-06-07/05:09:59', '2013-06-07/05:42:59'])
    df_info['rbspa'].time_range = time_double(['2013-06-07/04:49:20', '2013-06-07/05:25:20'])
    df_info['rbspb'].time_range = time_double(['2013-06-07/04:51:40', '2013-06-07/05:32:40'])
    df_info['thd'].time_range = time_double(['2013-06-07/05:59:39', '2013-06-07/06:28:00'])
    df_info['the'].time_range = time_double(['2013-06-07/05:48:00', '2013-06-07/06:21:00'])
    df_info['g13'].time_range = time_double(['2013-06-07/05:38:19', '2013-06-07/05:58:59'])
...
;---Tune ranges.
    set_yaxis, 'g15_b_tilt', range=[10,70]
    set_yaxis, 'rbspb_b_tilt', range=[5,35]
    set_yaxis, 'rbspa_b_tilt', range=[5,35]
    set_yaxis, 'thd_b_tilt', range=[10,90]
    set_yaxis, 'the_b_tilt', range=[10,90]
    set_yaxis, 'g13_b_tilt', range=[10,60]
...
;---Plot settings.
    ...
    if keyword_set(test) then begin
        ...
        file = join_path([srootdir(),'fig_2013_0607_05_tilt_angle.pdf'])
        magnify = 1
    endelse
...
;---Panel for position.
    ...
    if keyword_set(test) then begin
        ...
        file = join_path([srootdir(),'fig_2013_0607_05_sc_pos.pdf'])
        magnify = 1
    endelse
