...
pro loadct2,ct,invert=invert,reverse=revrse,file=file,previous_ct=previous_ct,silent = silent, _extra = extra
...
if ct ge 44 then loadct, ct, bottom = bottom_c, silent = silent else $
loadct,ct,bottom=bottom_c,file=file,silent = silent, _extra = extra
