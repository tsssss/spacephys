...
; ASI keogram.
;-
pro _2015_0317_load_data

; settings.
utr = time_double(['2015-03-17/06:00','2015-03-17/07:00'])
utr = time_double(['2015-03-17/06:00','2015-03-17/09:00'])
probes = ['b']
datfn = shomedir()+'/psbl_de_32hz/2015_0317_data.tplot'


utr = time_double(['2013-04-14/05:00','2013-04-14/08:00'])
probes = ['a']
datfn = shomedir()+'/psbl_de_32hz/2013_0414_data.tplot'


utr = time_double(['2013-02-08/07:00','2013-02-08/08:00'])
probes = ['b']


utr = time_double(['2014-12-22/01:00','2014-12-22/03:00'])
probes = ['a']


utr = time_double(['2013-02-14/05:00','2013-02-14/06:00'])
probes = ['b']
...
utr = time_double(['2013-05-02/02:00','2013-05-02/04:00'])
probes = ['a']


utr = time_double(['2015-04-16/07:30','2015-04-16/09:00'])
probes = ['a']
...
;utr = time_double(['2015-03-18/01:00','2015-03-18/08:00'])
;probes = ['a']
;datfn = shomedir()+'/psbl_de_32hz/2015_0318_data.tplot'
...
datvars = ['rbsp'+probes+'_'+vars]    ; basic variables.

vars = ['e_en_mageis','e_en','e_pa','h_en','h_pa','o_en','o_pa','ni','n','t']
ptlvars = ['rbspb_'+vars]    ; HOPE and MAGEIS data.

vars = []
vars = ['fpt_'+['mlat','mlon','mlt'],'map_coef','bmod_gse_'+models]
vars = [vars,'de_fac','db_fac','db_gse','b0_gse']
dervars = ['rbsp'+probes+'_'+vars]    ; derived variables.
...
ofn = shomedir()+'/'+time_string(utr[0],tformat='YYYY_MMDD')+'_overview.pdf'
...
ylim, 'rbsp?_e_uvw', -1
vars = pre0+['e_uvw','vsc','vsvy','b_gse','h_en','h_pa','e_en','e_pa','e_en_mageis','n','t']
vars = pre0+['b_gse','h_en','e_en','n','t']
nvar = n_elements(vars)
poss = sgcalcpos(nvar)
labs = pre0+['mlt','lshell','mlat']
tplot, vars, var_label=labs, trange=utr, position=poss
