...
;---Settings.
    ...
    plot_time = time_double('2014-08-28/10:20')
    species = 'e'
...
;if ~keyword_set(test) then if the_test_time eq plot_time then continue
        ...
        if probe eq '1991-080' then test_mlt = 0
...
;    endforeach
    ...
    ofn = join_path([root_dir,'case2_fig_ele_injection2.pdf'])
    ...
    options, vars, 'labels', ' '
    options, vars, 'ytitle', ' '
    tplot, vars, trange=plot_time_range, position=left_poss, /noerase
