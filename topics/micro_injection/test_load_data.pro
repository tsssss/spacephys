...
foreach species, ['o','p'] do begin
    pad_var = mms_read_pad_ion_thermal(tr, probe=probe, species=species)
    en_var = pad_get_en_spec(pad_var=pad_var)
    pa_var = pad_get_pa_spec(pad_var=pad_var, energy_range=[100,1e5])
endforeach
