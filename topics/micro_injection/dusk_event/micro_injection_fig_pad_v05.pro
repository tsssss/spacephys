...
; change Ele to e-.
;-
function micro_injection_fig_pad_v05, input_event_id, probe=probe, $
...
;---Load more data
    ...
    options, var, yrange=[-5,28], ytickv=[0,10,20], yminor=4, yticks=2, constant=[0,10,20]
...
print, micro_injection_fig_pad_v05(event_id, probe=probe, test=0, update=1)
end