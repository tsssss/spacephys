...
;---Settings.
    ...
    the_probes = ['the','tha','thd','g15','1991-080','g13','rbspb','1994-084']
...
;---Plot.
    ...
    if keyword_set(test) then begin
        ...
        file = join_path([sparentdir(srootdir()),'plot','fig_case2_kev_e_flux_all.pdf'])
        magnify = 1
    endelse
    ...
    ; y-labels.
    options, '1994-084_kev_e', 'yrange', [1,1e5]
