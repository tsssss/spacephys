...
;-
function micro_injection_fig_wavelet_for_dawn_v01, input_event_id, probe=probe, $
...
;---Phase diff zoom in.
    tickinterval = 600
    tplot_options, 'tickinterval', tickinterval
    zoom_tr = time_double(['2016-03-05/20:20','2016-03-05/21:20'])
    zoom_tr = time_double(['2016-03-05/18:40','2016-03-05/19:30'])
    tpos = bottom_poss[*,1]
...
print, micro_injection_fig_wavelet_for_dawn_v01(event_id, probe=probe, test=1, update=1)
end