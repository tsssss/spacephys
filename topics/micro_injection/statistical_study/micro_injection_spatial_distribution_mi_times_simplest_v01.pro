...
function micro_injection_spatial_distribution_mi_times_simplest_v01, mission_probe, test=test
...
test = 1
mission_probe = ['mms','1']
print, micro_injection_spatial_distribution_mi_times_simplest_v01(mission_probe, test=test)
end