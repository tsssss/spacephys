...
function micro_injection_fig_ulf_v03, input_event_id, probe=probe, $
...
;---Plot settings.
    ...
    tplot, bottom_vars, position=my_pos, noerase=1, trange=tr
    foreach var, bottom_vars, vid do begin
        tpos = my_pos[*,vid]
...
print, micro_injection_fig_ulf_v03(event_id, probe=probe, test=0, update=1)
end