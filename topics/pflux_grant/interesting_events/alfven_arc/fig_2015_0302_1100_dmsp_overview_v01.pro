...
function fig_2015_0302_1100_dmsp_overview_v01, plot_file, event_info=event_info, test=test
...
test=0
    ...
    ssusi_time = time_double('2015-03-02/11:20')
    asi_time = time_double('2015-03-02/11:01')
    time_range = time_double('2015-03-02/'+['11:18','11:23:00'])
    dmsp_orbit_time_range = time_double(['2015-03-02/11:18','2015-03-02/11:23'])
    dmsp_plot_time_range = time_range     ; for tplot.
    invertedv_times = time_double(['2015-03-02/11:19:35','2015-03-02/11:20:45'])
...
;    mlt_image = mlt_image[0:npx*0.5-1,0:npx*0.5-1]
    ...
    foreach the_info, aurora_info do begin
        ...
        msg = 'Arc '+the_info.hemisphere+', during PE!C(Poleward Expansion)'
        if the_info.hemisphere eq 'north' then ty1 += ychsz*1
        if the_info.hemisphere eq 'south' then msg = 'Arc '+the_info.hemisphere+', after PE'
        xyouts, tx1+xchsz*0.5, ty1-ychsz*0.3, msg, normal=1, alignment=0.0
    endforeach
...
;---DMSP SSUSI.
    ...
    foreach invertedv_time, invertedv_times do begin
        ...
        msg = invertedv_text
        xyouts, tx1+xchsz*0.5, ty1-ychsz*0.3, msg, normal=1, alignment=0.0, color=invertedv_color
    endforeach
...
;---RBSP.
    ...
    foreach the_info, aurora_info do begin
        ...
        xyouts, tx-xchsz*0,ty-ychsz*1.2, alignment=0.5,normal=1, 'RBSP-'+strupcase(probe), color=sc_color, charsize=sc_label_size
    endforeach
...
test = 0
print, fig_2015_0302_1100_dmsp_overview_v01(event_info=event_info, test=test)
end
