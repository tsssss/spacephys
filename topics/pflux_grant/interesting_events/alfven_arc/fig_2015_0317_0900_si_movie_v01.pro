...
function fig_2015_0317_0900_si_movie_v01, movie_file, event_info=event_info
...
test = 0
    ...
    time_range = time_double(['2015-03-17/08:30','2015-03-17/09:30'])
...
print, fig_2015_0317_0900_si_movie_v01(event_info=event_info)
end