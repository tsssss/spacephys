...
function _2013_0501_load_data_fac_vars, event_info
    ...
    if load_data then begin
        time_var = _2013_0501_load_data_field_ut(get_name=1)
        b0_gsm_var = _2013_0501_load_data_b0_gsm(event_info)
...
function _2013_0501_load_data_plasma_param, event_info
...
function _2013_0501_load_data_weygand_ut, event_info, time_var=var, get_name=get_name
...
function _2013_0501_load_data_weygand, event_info, time_var=time_var
...
;---Plasma parameters.
    event_info['plasma_param_time_range'] = time_double(['2013-05-01/07:35','2013-05-01/07:42'])
    param_vars = _2013_0501_load_data_plasma_param(event_info)
