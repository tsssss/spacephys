...
function mms_gen_survey_plot, input_time_range, probe=probe, $
    ...
    routine = 'mms_gen_survey_plot_'+version
...
foreach input_time_range, input_list do begin
    ...
    foreach day, days do begin
        ...
        foreach probe, probes do begin
            ...
            files = mms_gen_survey_plot(the_time_range, probe=probe, xpansize=6, test=test)
        endforeach
    endforeach
endforeach
