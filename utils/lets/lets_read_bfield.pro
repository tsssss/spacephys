function lets_read_bfield, time_range, probe=mission_probe, $
    ...
    ; Get var_info.
    routine = routine_name+'_read_bfield'
...
time_var = 'rbsp_bfield_time'
time_step = 1d/64
common_times = make_bins(time_double(time_range),time_step)
tmp = save_data_to_memory(time_var, common_times)
foreach probe, ['rbspa','rbspb'] do print, lets_read_bfield(time_range, probe=probe, save_to=data_file, time_var=time_var, resolution='hires')
end