...
function micro_injection_themis_2009_0619_fig_themis_v01, test=test

    plot_dir = srootdir()
    base = 'micro_injection_themis_2009_0619_fig_themis_v01.pdf'
...
test = 0
print, micro_injection_themis_2009_0619_fig_themis_v01(test=test)
end
