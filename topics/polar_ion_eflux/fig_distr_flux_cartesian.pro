...
pro fig_distr_flux_cartesian, dattype, bintype
...
;---Read data and bininfo.
    for l=0, nyr-1 do begin
        ...
        ;if strmid(dattype,10,/reverse_offset) eq 'number_flux' then begin
...
;    stop
    ...
    sgcolorbar, findgen(top), /horizontal, position=pos1, /noerase, ct=ct0, $
        zrange=zrang, ztitle=ztitl, zstyle=1, $
...
foreach tvar, vars do fig_distr_flux_cartesian, tvar
end
