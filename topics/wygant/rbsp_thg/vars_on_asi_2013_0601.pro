...
;-
pro vars_on_asi_2013_0601, asivar, asivars = asivars, pltvars = pltvars, $
...
ofn = shomedir()+'/thg_photon_count_2013_0501_log_scale.eps'
sgpsopen, ofn, xsize = 5, ysize = 6, /inch
...
ylim, vars, 0,100, 0
options, vars, 'ystyle', 1
ofn = shomedir()+'/thg_photon_count_2013_0501_linear_scale.eps'
sgpsopen, ofn, xsize = 5, ysize = 6, /inch
tr = time_double(['2013-05-01/07:14','2013-05-01/08:14'])
titl = 'Photon count, '+stodate(tr[0],'%H:%M')+' - '+stodate(tr[1],'%H:%M')
poss = sgcalcpos(nvar, position = posu)
