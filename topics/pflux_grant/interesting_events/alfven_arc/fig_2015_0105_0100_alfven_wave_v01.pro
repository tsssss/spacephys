...
function fig_2015_0105_0100_alfven_wave_v01, plot_file, event_info=event_info
...
;---ASI around footpoint.
    ...
    foreach time, times, time_id do begin
        ...
        mlat_index = where_pro(ybins, '[]', the_mlat_range, count=nybin)
...
print, fig_2015_0105_0100_alfven_wave_v01(event_info=event_info)
end