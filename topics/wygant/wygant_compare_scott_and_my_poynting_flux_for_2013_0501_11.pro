...
pro wygant_compare_scott_and_my_poynting_flux_for_2013_0501_11

    rootdir = shomedir()+'/Google Drive/works/data/wygant/rbspb_2013_0501_pflux_scott'
    tr = time_double(['2013-05-01/11:00','2013-05-01/11:40'])
    dt = 3600d  ; 1 hour padding time.
    trtot = tr+[-1,1]*dt
...
;    ofn = shomedir()+'/2013_0501_poynt_compare.eps'
;    sgpsopen, ofn, xsize = 7, ysize = 6, /inch
...
;    sgpsclose, /pdf
    ...
    ofn = shomedir()+'/2013_0501_poynt_compare'
    vars = 'shengs_pflux'+['_f1','_f2','_f3','']
