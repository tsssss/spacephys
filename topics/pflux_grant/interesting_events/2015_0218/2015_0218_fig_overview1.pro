    ...
    timespan, long_time_range[0], total(long_time_range*[-1,1]), /second
...
;---Region 1.
    margins = [9,4,7,1]
    ypans = [1,1,0.6]
    poss = panel_pos(plot_file, ypans=ypans, $
        'resize', xsize=4, ysize=3, margins=margins, $
        fig_size=fig_size)
