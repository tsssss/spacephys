...
function fig_rbspb_ps_crossing_v01, plot_dir, event_info=event_info, test=test
    ...
    kaw_times = time_double('2015-03-17/'+['06:50','07:08','07:48','08:53','09:11','09:23','09:38','09:49'])
    ps_times = time_double(['2015-03-17/06:15','2015-03-17/06:45'])
...
;        fc_vars.add, var
        ...
        plot_file = join_path([plot_dir,'fig_rbspb_ps_crossing_'+id+'_'+version+'.pdf'])
...
print, fig_rbspb_ps_crossing_v01(event_info=event_info, test=0)
end