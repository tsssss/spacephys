...
pro fig_2014_0828_10_tilt_angle, sort_by=sort_by, sort=sort
...
;---Tune ranges.
    ...
    set_yaxis, 'g15_b_tilt', range=[20,80]
    set_yaxis, 'the_b_tilt', range=[10,60]
    set_yaxis, 'tha_b_tilt', range=[0,50]
    set_yaxis, 'rbspb_b_tilt', range=[17,27]
    set_yaxis, 'g13_b_tilt', range=[33,49]
...
;---Plot settings.
    ...
    if keyword_set(test) then begin
        ...
        file = join_path([srootdir(),'fig_2014_0828_10_tilt_angle.pdf'])
        magnify = 1
    endelse
...
;---Panel for position.
    ...
    if keyword_set(test) then begin
        ...
        file = join_path([srootdir(),'fig_2014_0828_10_sc_pos.pdf'])
        magnify = 1
    endelse
