function micro_injection_themis_2009_0619_fig_tha_v01, test = test
    ...
    yrange = [16.5, 10]
    plot_dir = srootdir()
    base = 'micro_injection_themis_2009_0619_fig_tha_v01.pdf'
...
test = 0
print, micro_injection_themis_2009_0619_fig_tha_v01(test = test)
end
