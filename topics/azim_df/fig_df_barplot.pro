;+
; Plot properties like event extent, DF width, ... .
;-
...
;            endif
    ...
    keys = ['time_extent','mlt_extent','rxy_extent','v2d_mag','v2d_mag_stddev','omega','width_re','width_deg']
    ...
    fig_xsize = 6
    fig_ysize = 5
    plot_file = join_path([project.plot_dir,'fig_df_barplot.pdf'])
