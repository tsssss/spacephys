...
function fig_2015_0105_0100_si_movie_v01, movie_file, event_info=event_info
...
;---Loop through the times.
    ...
    ;---Add footpoint.
        ...
        foreach external_model, models, model_index do begin
            ...
            xyouts, tx+xchsz*1,ty-ychsz*0.3,normal=1, 'RBSP-B', color=sc_color, charsize=label_size
...
print, fig_2015_0105_0100_si_movie_v01(event_info=event_info)
end