...
options, 'rbspa_pf_map_fac_mat', 'yrange', [-50,100]

options, 'rbspb_pf_map_fac_mat', 'yrange', [-80,160]
...
ofn = 0
ofn = shomedir()+'/fig_rbsp_overview2.pdf'
...
tvar = ['e_en','n_combine','bmag','pf_fac_mat_map']
