...
;-
function micro_injection_fig_pad_for_dawn_v01, input_event_id, probe=probe, $
...
probe = '4'
event_id = '2017_0112_00'
print, micro_injection_fig_pad_for_dawn_v01(event_id, probe=probe, test=1, update=1)
end