...
pro azim_prop_gen_storm_keo_ewo, time_range, $
...
;---Generate the plot.
    ...
    file = join_path([homedir(),'fig_azim_prop_storm_keo_ewo_'+time_string(time_range[0],tformat='YYYY_MMDD')+'.pdf'])
...
; Read from /Volumes/GoogleDrive/My Drive/works/works/azim_prop/ten_event_paper/data/storm_list.txt
    ...
    foreach time_range, storm_list do azim_prop_gen_storm_keo_ewo, time_range
