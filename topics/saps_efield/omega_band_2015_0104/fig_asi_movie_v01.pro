...
function fig_asi_movie_v01, test=test, event_info=event_info
...
;---Settings.
    ...
    mlt_type = 'night'
    asi_zlog = 0
    if asi_zlog eq 0 then asi_zrange = [-1,1]*1e4 else asi_zrange = [5e1,2e4]
    asi_ct = 70
...
print, fig_asi_movie_v01(test=0, event_info=event_info)
end
