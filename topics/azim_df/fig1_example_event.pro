...
;---Draw v_2d and triads.
    ...
    foreach triad, triad_list do begin
        ...
        arrow, x0,y0,x1,y1,/data, solid=arrow_solid, $
            hsize=arrow_hsize*1.5, color=sgcolor('black')
    endforeach
    ...
    foreach df, df_list, ii do begin
        ...
        if probe eq 'g15' then begin
            tx = tmp[0]-xchsz*0.5
            ty = tmp[1]
            xyouts, tx,ty,/normal, alignment=1, strupcase(short_name), color=sgcolor('black')
        endif else begin
            tx = tmp[0]+xchsz*0.5
            ty = tmp[1]
            xyouts, tx,ty,/normal, strupcase(short_name), color=sgcolor('black')
        endelse
    endforeach
