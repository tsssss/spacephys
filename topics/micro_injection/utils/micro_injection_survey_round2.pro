...
function micro_injection_survey_round2

    ; Survey round 2
    project_id = 'micro_injection'
    project_info = project_load(project_id)
    root_dir = project_info.root_dir
    event_list_file = join_path([root_dir,project_id+'_survey_round1_event_list.txt'])
    survey_file = join_path([project_info.data_dir,project_id+'_survey_round2_survey_info.sav'])
    ...
    trs = micro_injection_load_round1_event_list_time_range(event_list_file)
    probes = ['1','2','3','4']
    test = 0
